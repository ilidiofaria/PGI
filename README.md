...
Aplicação para converter listagens de vidro em PDF ou o DWG de referência num ficheiro `IMPORT_EXCEL.xlsx` compatível com o ERP.

## Fluxo

1. Iniciar sessão.
2. Carregar um PDF ou o DWG de referência.
3. Utilizar dados de referência ou processar com OpenAI ou Anthropic.
